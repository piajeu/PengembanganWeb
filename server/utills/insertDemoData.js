...
async function insertDemoData() {
  try {
    // Insert demo categories - Ubah ke createMany untuk skip duplikat
    ...
    // Insert demo products - Ubah ke createMany untuk skip duplikat
    ...
    // Insert demo brands
    const demoBrands = [
      { name: 'Samsung', description: 'Merek elektronik terkemuka dari Korea Selatan', status: true },
      { name: 'Apple', description: 'Produk inovatif dari Amerika, fokus pada desain premium', status: true },
      { name: 'Sony', description: 'Spesialis gadget Jepang dengan kualitas tinggi', status: true },
      { name: 'Xiaomi', description: 'Merek China dengan harga terjangkau dan fitur canggih', status: false },
    ];
    ...
    console.log('Demo brands inserted successfully!');
  } catch (error) {
